<?php
    ...
    $id = $_SESSION['active'];
    $qry = "select * from admin_detail where email = '$id'";
...
<html>
	...
	<div class="header">Profile</div>
		...
		<form action="updateProfile.php" method="post">
            ...
            <input type="number" name="aid" value="<?php echo $result['aid']?>" onfocus="show(1)" placeholder="ID" required/><br><br>
            
            <div id="fmName" style="color:white; font-size:20px;"></div>
            <input type="text" name="name" onfocus="show(2)" value="<?php echo $result['aname']?>" placeholder="Name" required/><br><br>
            ...
            <input type="text" onfocus="show(5)" name="contact" value="<?php echo $result['contact']?>" placeholder="Contact" required/><br><br>
            ...
            function show(c)
            {
                switch(c)
                {
                    ...
                    case 5:
                        ...
                        document.getElementById("fmCnt").innerHTML = "Contact"; 
                    break;
