...
<html>
	...
	<body>
	<div class="header">STUDENT SIGN UP</div>
		<div class="context">
		<form action="insertStudent.php" method="post">
            <div id="fmID" style="color:white; font-size:20px;"></div>
            <input type="number" name="sid" onfocus="show(1)" placeholder="ID" required/><br><br>
            ...
            <input type="text" onfocus="show(5)" name="branch" placeholder="Branch" required/><br><br>
            ...
            function show(c)
            {
                switch(c)
                {
                    ...
                    case 5:
                        ...
                        document.getElementById("fmCnt").innerHTML = "Enter Branch"; 
                    break;
        ...
        <div class="acc">
            <a href="student_signin.php">Already Exist? SIGN IN</a>
        </div>
	</body>
</html>